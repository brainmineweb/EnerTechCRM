...
//
// The Parent Dish picker uses a server-side query that shows every
// non-cancelled top-level Dish (including amended ones like
// EUPL/26/09/007-1), with this Sales Order's Dishes listed first.
//
	...
	const dialog = new frappe.ui.Dialog({
		...
		fields: [
			...
			},
			{
				...
				description:
					"Only top-level, non-cancelled Dishes can be picked as a parent. Dishes of this Sales Order are listed first.",
				get_query: () => ({
					query: "enertechv1.enertechv1.doctype.dish.dish.parent_dish_query",
